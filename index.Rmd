...
+ [Lecture 13](slides/36-315_Summer2021_Lec13.html): text analysis with `tidytext` and tables with `kableExtra`
+ [Lecture 13](slides/36-315_Summer2021_Lec13_addl.html): tables with `gt` and `gtsummary`
+ [Lecture 14](slides/36-315_Summer2021_Lec14.html): presentations with `xaringan`
+ [Lecture 15](slides/36-315_Summer2021_Lec15.html): animation with `gganimate`, interactivity with `plotly`, and iteration with `purrr`
